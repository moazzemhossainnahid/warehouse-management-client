...
<div className="container my-24 px-6 mx-auto">
  ...
  <section className="mb-32 text-gray-800">
    ...
    <h2 className="text-3xl font-bold mb-12 text-center">About Our Management Services</h2>
    ...
    <div className="flex flex-wrap items-center">
      <div className="grow-0 shrink-0 basis-auto w-full lg:w-5/12 mb-12 lg:mb-0 md:px-6 ">
        <div className="relative overflow-hidden bg-no-repeat bg-cover rounded-lg shadow-lg " data-mdb-ripple="true"
          ...
          <img src="https://mdbootstrap.com/img/new/textures/full/126.jpg" alt='' className="w-full" />
          <a href="#!">
              ...
              <div className="flex justify-center items-center h-full">
                <div className="px-6 py-12 md:px-12 text-white text-center">
                  <h3 className="text-2xl uppercase font-bold mb-6">
                    The future is <u className='text-none' style={{color: 'hsl(231, 52.6%, 85%)'}}>now</u>
                  </h3>
      ...
      <div className="grow-0 shrink-0 basis-auto w-full lg:w-7/12 md:px-6">
        ...
        <div className="flex items-center justify-center mb-12">
          ...
          <div className="grow ml-4">
            ...
            <p className="text-gray-500">
            In our modern digital world security is the highest priority for organizations, both big and small. Not only data but also personal space of employees should be protected. Your company may have its own set of security rules and guidelines.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center mb-12">
          ...
          <div className="grow ml-4">
            ...
            <p className="text-gray-500">
            Fast Deliver is a fast growing and promising courier and parcel service in Bangladesh. With excellent customer service, Customers can count on us to deliver best performance on their behalf. 
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="grow ml-4">
            ...
            <p className="text-gray-500">
            Our tracking & measurement solutions provide insights to improve live customer experiences, optimise operational costs and increase sales.
            </p>
          </div>
        </div>
      </div>
