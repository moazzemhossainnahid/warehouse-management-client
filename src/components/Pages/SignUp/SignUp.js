...
const SignUp = () => {
    ...
    const {passError,conPassError,handleSignupForm} = useFirebase();
    return (
  ...
  <form onSubmit={handleSignupForm}>
    <div className="form-group mb-6">
      <label for="exampleInputEmail1" className="form-label inline-block mb-2 text-gray-700">Name</label>
      <input type="text" className="form-control
        ...
        aria-describedby="emailHelp" name='name' required placeholder="Email Your Name"/>
    </div>
    <div className="form-group mb-6">
    ...
    <div className="form-group mb-6">
      <label for="exampleInputPassword3" className="form-label inline-block mb-2 text-gray-700">Confirm Password</label>
      <input type="password" className="form-control block
        w-full
        px-3
        py-1.5
    ...
    <div className="flex justify-between items-center mb-6">
      <div className="form-group form-check">
        <input type="checkbox"
          ...
          id="exampleCheck2"/>
        <label className="form-check-label inline-block text-gray-800" for="exampleCheck2">Accept Terms & Condition.</label>
      </div>
    </div>
