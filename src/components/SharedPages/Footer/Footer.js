...
const Footer = () => {
    return (
        <footer className="text-center mt-6 bg-gray-900 text-white">
  <div className="container px-6 pt-6">
    ...
    <div className="grid lg:grid-cols-4 md:grid-cols-2 pb-5">
      <div className="mb-6 text-left mx-auto">
        <h5 className="uppercase font-bold mb-2.5">Usefull Links</h5>
      ...
      <div className="mb-6 text-left mx-auto">
        ...
        <ul className="list-none mb-0">
          <li>
            <a href="#!" className="text-white">Potato</a>
          </li>
          <li>
            <a href="#!" className="text-white">Onion</a>
          </li>
          <li>
            <a href="#!" className="text-white">Eggplant</a>
          </li>
          <li>
            <a href="#!" className="text-white">Radish</a>
          </li>
        </ul>
      </div>
      ...
      <div className="mb-6 text-left mx-auto">
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Development</a>
          </li>
          <li>
            <a href="#!" className="text-white">Business Plan</a>
          </li>
        </ul>
      </div>
  ...
  <div className="text-center p-4" style={{backgroundColor: 'rgba(0, 0, 0, 0.2)'}}>
    ...
    <a className="text-orange-500" href="https://tailwind-elements.com/"> Vegetables Planet</a>
